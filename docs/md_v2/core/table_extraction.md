...
> 
> **✅ NOW AVAILABLE**: 
> `DefaultTableExtraction` handles complex table structures (rowspan, colspan, nested tables) for **FREE**, reducing the need for costly LLM extraction in most cases.
