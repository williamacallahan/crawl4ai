...
@pytest.mark.parametrize("headers,status", [({"content-length": "invalid"}, 200), ({}, 500)])
def test_failed_download_closes_response_and_session(monkeypatch, headers, status):
    import sys
    ...
    with pytest.raises(RuntimeError):
        strategy._get_pdf_path("https://public.example/doc.pdf")
