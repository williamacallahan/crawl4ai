...
from crawl4ai.domain_mapper import DomainMapper, _BoundedClient, _bounded_stream
...
# ─────────────────────────────────────────────────────────────────────────
#  _BoundedClient / _bounded_stream unit tests (wrapper contract)
# ─────────────────────────────────────────────────────────────────────────
...
class TestBoundedClientWrapper:
    ...
    async def test_stream_releases_semaphore_on_enter_error(self):
        ...
        cm = _bounded_stream(_FailCM(), wrapped._sem)
